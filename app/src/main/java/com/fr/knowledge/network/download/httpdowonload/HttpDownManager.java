...
import com.fr.knowledge.network.download.exception.HttpTimeException;
import com.fr.knowledge.network.download.exception.RetryWhenNetworkException;
...
import com.fr.knowledge.network.download.httpdowonload.DownInfo.DownState;
    ...
    public void startDown(final DownInfo info, HttpProgressOnNextListener<DownInfo> httpProgressOnNextListener) {
        ...
        if (downInfos.contains(info)) {
            ...
            OkHttpClient.Builder builder = new OkHttpClient.Builder()
                    .connectTimeout(info.getConnectionTime(), TimeUnit.SECONDS)//手动创建一个OkHttpClient并设置超时时间
