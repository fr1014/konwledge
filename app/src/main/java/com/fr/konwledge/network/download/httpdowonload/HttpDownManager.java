...
import com.fr.konwledge.network.download.exception.HttpTimeException;
import com.fr.konwledge.network.download.exception.RetryWhenNetworkException;
import com.fr.konwledge.network.download.http.HttpService;
import com.fr.konwledge.network.download.listener.HttpProgressOnNextListener;
import com.fr.konwledge.network.download.httpdowonload.DownInfo.DownState;
